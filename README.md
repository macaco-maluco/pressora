...
~~~sh
# getting the code
git clone git@github.com:nko5/macaco-frito.git && cd ./macaco-frito/
...
# deploying to Modulus (to http://macaco-frito.2015.nodeknockout.com/)
modulus deploy
...
~~~html
<iframe src="http://nodeknockout.com/iframe/macaco-frito" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
